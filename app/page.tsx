...
// Display names for states (maps data key to user-friendly display name)
const STATE_DISPLAY_NAMES: { [key: string]: string } = {
  'ALL India': 'All India'
};

// Helper to get display name for a state
...
export default function Home() {
  ...
  const toggleState = (state: string) => {
    ...
    if (isSelected) {
      ...
      // If no states left, auto-select 'ALL India'
  ...
  const generateChartTitle = (
    ...
    let dateRange = `${startMonth?.slice(0, 3)} ${startYear} - ${endMonth?.slice(0, 3)} ${endYear}`
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-3 md:px-6 py-4 md:py-6">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          {/* Live Preview Chart */}
          <div ref={chartPreviewRef} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-4 md:p-5 shadow-xl flex-1 min-w-0">
        ...
        <div className="mt-6 md:mt-8 bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-5 md:p-8 shadow-xl">
          <h2 className="text-xl md:text-2xl font-bold text-slate-100 mb-6 md:mb-8">Understanding the Consumer Price Index</h2>
          ...
          <div className="space-y-6 md:space-y-8 max-w-4xl">
            ...
            <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-5 md:p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-slate-100">Category Weights (Combined Index)</h3>
              </div>
              <p className="text-base text-slate-400 mb-4 ml-1">Each category contributes differently to the overall CPI based on average household spending:</p>
              <div className="space-y-3 ml-1">
                {[
                  { name: 'Food and beverages', weight: 45.86, color: '#ec4899', desc: 'Largest component - cereals, vegetables, fruits, meat, dairy' },
                  { name: 'Miscellaneous', weight: 28.32, color: '#a855f7', desc: 'Education, health, transport, communication, recreation' },
                  { name: 'Housing', weight: 10.07, color: '#06b6d4', desc: 'Rent and housing maintenance (Urban only)' },
                  { name: 'Fuel and light', weight: 6.84, color: '#f97316', desc: 'LPG, electricity, kerosene, firewood' },
                  { name: 'Clothing and footwear', weight: 6.53, color: '#14b8a6', desc: 'Garments, footwear, tailoring' },
                  { name: 'Pan, tobacco, intoxicants', weight: 2.38, color: '#84cc16', desc: 'Tobacco products, betel, liquor' },
                ].map((item) => (
                  <div key={item.name} className="flex items-start gap-3 py-2 border-b border-slate-700/30 last:border-0">
                    <span
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className="text-base font-semibold text-slate-100">{item.weight}%</span>
                      </div>
            ...
            <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-5 md:p-6">
              ...
              <ul className="space-y-3 ml-1">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></span>
                  <span className="text-base text-slate-300"><strong className="text-slate-200">Rural:</strong> Higher food weight (~54%) due to higher food expenditure share</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></span>
                  <span className="text-base text-slate-300"><strong className="text-slate-200">Urban:</strong> Includes Housing component, higher miscellaneous weights</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></span>
                  <span className="text-base text-slate-300"><strong className="text-slate-200">Combined:</strong> Weighted average of Rural and Urban indices</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900/50 rounded-xl border border-slate-700/50 p-5 md:p-6">
              ...
              <ul className="space-y-3 ml-1">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 flex-shrink-0"></span>
                  <span className="text-base text-slate-300">Compare values across time to see inflation trends</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 flex-shrink-0"></span>
                  <span className="text-base text-slate-300">Compare across states to see regional price differences</span>
                </li>
              </ul>
            </div>
          </div>
