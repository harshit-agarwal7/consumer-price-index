          ...
          {editingChartId ? (
            <>
              <button
                ...
                className="px-3 py-1.5 md:px-4 md:py-2 bg-green-600 hover:bg-green-500 text-white text-sm font-medium rounded-lg transition-colors duration-200 flex items-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-3 py-1.5 md:px-4 md:py-2 bg-slate-600 hover:bg-slate-500 text-white text-sm font-medium rounded-lg transition-colors duration-200 cursor-pointer"
              >
                Cancel
              </button>
            </>
            ...
            <button
              onClick={onAddChart}
              className="px-3 py-1.5 md:px-4 md:py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors duration-200 flex items-center gap-2 cursor-pointer"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
